...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Documentos Internos') }}</div>

                <div class="card-body">
                    <!-- Botón para crear un nuevo documento -->
                    <a href="{{ route('documentos.create') }}" class="btn btn-success mb-3">Crear Nuevo Documento</a>
                    
                    <!-- Verificar si hay documentos internos -->
                    @if($documentos->isEmpty())
                        <div class="alert alert-warning">No hay documentos internos disponibles.</div>
                    @else
                        <table class="table">
                            <thead>
                                <tr>
